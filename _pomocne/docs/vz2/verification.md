...
* `_pomocne/docs/vz2/design.md` – model, práva, transakce, úložiště, přechod, etapy.
* `_pomocne/docs/vz2/inventory.md` – aktuální soubory, úložiště, writery a konflikty.
* `_pomocne/docs/vz2/schema-draft.sql` – neaplikované schéma, 13 nových tabulek.
* `_pomocne/docs/vz2/verification.md` – tento protokol a scénáře.
...
`_pomocne/migrations/001_personal_accounts.sql`, potom schválený schema draft. Testovací
