...
Šablona je `_pomocne/deploy/vz2-storage/apache.htaccess`. Umísťuje se **pouze** do nového
...
Stručný návod je `_pomocne/deploy/vz2-storage/README.cs.md` a v ZIPu `CTI_PRVNI.txt`.
...
```text
node _pomocne/tools/vz2_storage_http_check.js prepare C:\temp\vz2-probes
node _pomocne/tools/vz2_storage_http_check.js check C:\temp\vz2-probes\manifest.json https://OVERENY-VEREJNY-KOREN/ [DALSI-ALIASY]
```
...
Lokálně `_pomocne/tests/vz2_legacy_probe.test.js`: **13 PASS** přes skutečné HTTP/PHP,
...
Následuje jednorázová ruční migrace **celého** `_pomocne/migrations/002_vz2.sql` v databázi
...
`_pomocne/deploy/vz2-beta/README.cs.md` popisuje nasazení ve dvou krocích: nejprve runtime
...
spojením. Konkrétní krátký blok je v `_pomocne/deploy/vz2-beta/README.cs.md`. Celý soubor
...
`_pomocne/config.vz2.example.php` nyní rozlišuje společný veřejný root a vlastní storage:
...
- `_pomocne/tests/vz2_storage.test.js`: **28 PASS** – rozlišení kořenů, povinné potvrzení,
...
- `_pomocne/tests/vz2_integration.test.js`: poslední běh **60 PASS** – obsahové scénáře,
...
Upravené soubory: `_pomocne/config.vz2.example.php`, `php/inc/vz2_storage.php`,
`tools/vz2_preflight.php`, `_pomocne/tests/vz2_integration.test.js`, `_pomocne/docs/vz2/stage2.md`,
`_pomocne/docs/vz2/hosting-verification.md`.
Nové: `_pomocne/deploy/vz2-storage/apache.htaccess`, `_pomocne/deploy/vz2-storage/README.cs.md`,
`tools/vz2_storage_probe.php`, `tools/vz2_storage_http_check.js`,
`tools/vz2_storage_probe_legacy.php`, `_pomocne/tests/vz2_legacy_probe.test.js`,
`_pomocne/tests/vz2_storage.test.js`, `php/inc/vz2_file_io.php`,
`_pomocne/deploy/vz2-beta/README.cs.md`, `_pomocne/docs/vz2/cleanup-live.md` a tento dokument.
