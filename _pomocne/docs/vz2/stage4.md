...
`_pomocne/migrations/003_vz2_discussion_body.sql` proto pouze rozšiřuje tento sloupec
...
- `_pomocne/tests/vz2_integration.test.js` s `VZ2_TEST_BROWSER=1`: **117 PASS**. Izolovaná
...
- Nový `_pomocne/tests/vz2_content.integration.js`: čtení bez založení dokumentu,
...
- Nový `_pomocne/tests/vz2_content.browser.js`: skutečný editor, konflikt a porovnání,
...
Nasazení a návrat na předchozí runtime: `_pomocne/deploy/vz2-stage4/README.cs.md`.
