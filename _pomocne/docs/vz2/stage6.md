...
Testy: nový `_pomocne/tests/vz2_navigation.browser.js`, upravené
`_pomocne/tests/vz2_integration.test.js` a `_pomocne/tests/vz2_timestamps.browser.js`.
Balíček a návod: `_pomocne/deploy/vz2-stage6/README.cs.md`, režim `stage6` v
