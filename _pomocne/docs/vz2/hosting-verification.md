...
- Starý uživatelský obsah se nepřevádí. Přesto je nutné jednorázově vytvořit 13
  nových tabulek pomocí `_pomocne/migrations/002_vz2.sql`.
...
Změněné soubory: `php/auth.php`, `_pomocne/migrations/002_vz2.sql`, `tools/vz2_preflight.php`,
`_pomocne/tests/vz2_integration.test.js`, `_pomocne/docs/vz2/stage2.md` a tento nový protokol.
