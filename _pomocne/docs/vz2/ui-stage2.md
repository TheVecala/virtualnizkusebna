...
- `_pomocne/tests/vz2_timestamps.browser.js` a `_pomocne/tests/vz2_navigation.browser.js`:
...
- Nový `_pomocne/tests/vz2_recordings.browser.js`, zapojený do integrační sady:
...
- Integrační sada `_pomocne/tests/vz2_integration.test.js` s `VZ2_TEST_BROWSER=1`:
