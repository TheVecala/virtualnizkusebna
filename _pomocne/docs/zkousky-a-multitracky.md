...
```sh
node _pomocne/tests/multitrack_contract.test.js
node _pomocne/tests/multitrack_sample_rate.test.js
node _pomocne/tests/multitrack_browser_smoke.test.js
php _pomocne/tests/admin_storage_test.php
```

`_pomocne/tests/workspace_integration.test.js` používá dočasnou kopii aplikace, vlastní
...
```sh
node _pomocne/tests/workspace_integration.test.js
```
