...
console.log("  <?php echo "vysledek= ".$vysledek.",  "."id= ".$_SESSION['id'].",  "."aktualni_diskuse =".$aktualni_diskuse.",  "."SESSION aktualni_diskuse= ".$_SESSION['diskuse'].",  "."nazev= ".$_SESSION['nazev'].", SESSION['chyba_prihlaseni= ". $_SESSION['chyba_prihlaseni']." adresa_pro_navrat =  ".$adresa_pro_navrat ;  ?>  ");  
