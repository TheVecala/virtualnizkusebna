...
- `tests/vz2_integration.test.js`: **39 kontrol PASS**, reálné HTTP přes PHP.
...
- Původní `tests/auth_integration.php`: **lifecycle 25 PASS, guest 19 PASS** s VZ2
...
`js/multitrack.js`, `tests/auth_integration.php`.

Nové v etapě 2: `config.vz2.example.php`, `migrations/002_vz2.sql`, `vz2.php`,
...
`tests/vz2_integration.test.js`, `docs/vz2/stage2.md`.

Z dřívější etapy stále necommitnuté: `docs/vz2/design.md`, `docs/vz2/inventory.md`,
`docs/vz2/schema-draft.sql`, `docs/vz2/verification.md`. Tyto čtyři dokumenty popisují
