...
- `tests/vz2_ideas.browser.js`: nové scénáře pracovní plochy Nápadů.
  `tests/vz2_content.browser.js` kontroluje sdílení a práva Nápadů na novém
  místě; `tests/vz2_integration.test.js` zapojuje nové scénáře.
